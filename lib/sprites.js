...
export function sprite(name, size = 24) {
  ...
  return `<img src="./sprites/${name}.webp" width="${size}" height="${size}" alt="${name}" style="display:inline-block;vertical-align:middle;image-rendering:pixelated" loading="lazy">`;
}
