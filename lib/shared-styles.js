...
sheet.replaceSync(/*css*/`
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  /* removed :active scale — cards aren't interactive */
  ...
  .badge-slot .badge-icon img { image-rendering: pixelated; display: block !important; }
  ...
  .badge-slot .badge-label {
    ...
    font-size: 8px; color: rgba(255,255,255,.8); text-align: center; width: 100%; left: 0;
  }
